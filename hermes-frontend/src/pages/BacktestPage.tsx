...
import {
  StrategyConfigPanel,
  DEFAULT_RISK_PARAMS,
  type RiskParamsState,
} from "@/components/backtest/StrategyConfigPanel";
...
export function BacktestPage() {
  ...
  const [riskParams, setRiskParams] = useState<RiskParamsState>({
    ...DEFAULT_RISK_PARAMS,
  });
                  ...
                  activeData.metrics["Total Trades"] !== "0" && (
                    <>
                      ...
                      <MetricCard
                        ...
                        icon={<Crosshair className="text-rose-400" size={18} />}
                        idx={7}
                      />
                    </>
                  )}
